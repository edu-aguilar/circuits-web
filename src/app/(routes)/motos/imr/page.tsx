...
export const metadata: Metadata = {
  title: "Motos IMR de asfalto - modelos y caracteristicas",
  description:
    "Resumen de modelos IMR para pitbike de asfalto: Copa Alevin, Corse, Race Pro y GP20 con distintas cilindradas.",
};
    ...
    <AppPage>
      <section className="rounded-2xl border border-black/10 bg-white p-8">
        ...
        <p className="mt-3 text-base text-black/60">
          Gama amplia de pitbikes asfalto con opciones desde 90cc hasta modelos de mayor cilindrada.
        </p>
      </section>
