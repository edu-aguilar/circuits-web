...
const motor = motoresData.find((m) => m.slug === "zs155");

export const metadata: Metadata = {
  title: `Motor ZS155 KLX para Pitbike - Especificaciones y Características | todopitbike.es`,
      ...
      <AppPage>
        <Breadcrumbs
          items={[
            ...
            { label: "ZS155", href: routes.motores.zs155.path },
          ]}
        />
        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="rounded-2xl border border-black/10 bg-white p-6">
            ...
            <h3 className="mt-4 text-lg text-black">¿Para quién es el ZS155?</h3>
            <p className="mt-2 text-sm text-black/60">{motor.audience}</p>
          </div>
        </section>

        <section className="mt-8 rounded-2xl border border-black/10 bg-white p-6">
          <h2 className="text-2xl text-black">Ventajas del ZS155</h2>
          <ul className="mt-4 list-disc space-y-2 pl-5 text-sm text-black/60">
