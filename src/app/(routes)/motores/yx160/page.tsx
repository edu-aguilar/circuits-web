...
const motor = motoresData.find((m) => m.slug === "yx160");

export const metadata: Metadata = {
  title: `Motor YX160 ZR1 para Pitbike - Especificaciones, Características y Cambio | todopitbike.es`,
      ...
      <AppPage>
        <Breadcrumbs
          items={[
            ...
            { label: "YX160", href: routes.motores.yx160.path },
          ]}
        />
        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="rounded-2xl border border-black/10 bg-white p-6">
            ...
            <h3 className="mt-4 text-lg text-black">¿Para quién es el YX160 ZR1?</h3>
            <p className="mt-2 text-sm text-black/60">{motor.audience}</p>
          </div>
        </section>

        <section className="mt-8 rounded-2xl border border-black/10 bg-white p-6">
          <h2 className="text-2xl text-black">Mejoras de la Versión ZR1</h2>
          <ul className="mt-4 list-disc space-y-2 pl-5 text-sm text-black/60">
