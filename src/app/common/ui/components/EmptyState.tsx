...
export const EmptyState = ({ title, description }: EmptyStateProps) => {
  ...
  return (
    <div className="w-full flex items-center flex-wrap justify-center gap-10">
      <div className="grid gap-4 w-80 rounded-2xl border border-black/10 bg-white p-6 text-center">
        <div className="w-16 h-16 mx-auto rounded-full border border-black/10 bg-white justify-center items-center inline-flex">
        ...
        <div>
          ...
          {description && (
            <p className="text-center text-black/70 text-sm font-normal leading-snug pb-4">{description}</p>
          )}
          ...
          <div className="flex gap-3">
            <button
              ...
              className="w-full px-3 py-2 rounded-full border border-black/10 text-black/80 text-xs font-semibold uppercase tracking-wide leading-4"
            >
              {" "}
              Recargar{" "}
            </button>
